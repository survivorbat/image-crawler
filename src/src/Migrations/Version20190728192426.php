 ...
 */
final class Version20190728192426 extends AbstractMigration
{
    /**
     * @return string
     */
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE saved_image (id VARCHAR(255) NOT NULL, scrape_origin_id VARCHAR(255) DEFAULT NULL, filename VARCHAR(255) DEFAULT \'\' NOT NULL, pathname VARCHAR(255) DEFAULT \'\' NOT NULL, base_name VARCHAR(255) DEFAULT \'\' NOT NULL, public_path VARCHAR(255) DEFAULT \'\' NOT NULL, real_path VARCHAR(255) DEFAULT \'\' NOT NULL, extension VARCHAR(255) DEFAULT \'\' NOT NULL, path VARCHAR(255) DEFAULT \'\' NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
